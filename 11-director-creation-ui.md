...
```
┌───────────────────────────┬───────────────┬─────────────────────┐
│  Scene Preview            │  Directorial  │  [≡] Creator Panel  │
│  Conversation Log         │  Controls     │  + New Character    │
│                           │               │  + New Location     │
│                           │               │  + Generate...      │
└───────────────────────────┴───────────────┴─────────────────────┘
```
...
┌─ Create Character ────────────────────────────────────────┐
│                                                           │
│  Name: [________________] [🪄 Suggest]                    │
│                                                           │
│  Description:                                             │
│  [                                        ] [🪄 Suggest]  │
│  [                                        ]               │
│                                                           │
│  Archetype: [Hero ▼]  [🪄 Suggest based on description]  │
│                                                           │
│  Wants/Goals:                                             │
│  [+ Add Want]  [🪄 Generate wants from archetype]        │
│                                                           │
│  [Generate Portrait]  [Generate Sprite]                   │
│                                                           │
...
┌─ Creation Assistant ──────────────────────────────────────┐
│                                                           │
│  DM: "I need a mysterious tavern keeper who knows        │
│       secrets about the missing merchant"                 │
│                                                           │
│  AI: I'll create this character:                         │
...
│  [                                                    ]   │
│                                                           │
│  Or choose a quick archetype:                            │
│  [Tavern Keeper] [Guard] [Merchant] [Noble] [Beggar]    │
│                                                           │
│  [Back]                                        [Next →]   │
└───────────────────────────────────────────────────────────┘
```
...
```
Name: [Bartender Jones    ] [🪄]  ← Click to get suggestion
...
```
┌── Form ──────────────────┐ ┌── AI Suggestions ─────────┐
│  Name: [_____________]   │ │  Based on context:        │
│  (cursor in name field)  │ │  • Marcus Blackwood       │
│                          │ │  • Old Tom                │
│                          │ │  • Whisper                │
│                          │ │  [Generate More]          │
└──────────────────────────┘ └───────────────────────────┘
...
│  ACTIVE                                                   │
│  ┌─────────────────────────────────────────────────────┐ │
│  │ ⏳ Jasper - Portrait (4 variations)    [███░░] 60%  │ │
│  └─────────────────────────────────────────────────────┘ │
│                                                           │
│  QUEUED                                                   │
│  ┌─────────────────────────────────────────────────────┐ │
│  │ ⏸ Town Square - Backdrop               [Waiting]    │ │
│  │ ⏸ Guard Captain - Sprite              [Waiting]    │ │
│  └─────────────────────────────────────────────────────┘ │
│                                                           │
│  READY FOR SELECTION (click to choose)                   │
│  ┌─────────────────────────────────────────────────────┐ │
│  │ ✓ Bartender - Portrait (4 options)    [Select →]   │ │
│  │ ✓ Forest Path - Backdrop (4 options)  [Select →]   │ │
│  └─────────────────────────────────────────────────────┘ │
│                                                           │
└───────────────────────────────────────────────────────────┘
```
...
```
┌─ Select Portrait for: Bartender Jasper ─────────────────────────────────────┐
│                                                                             │
│  Just Generated (batch from 2 min ago):                                     │
│  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐                        │
│  │         │  │         │  │  ★      │  │         │                        │
│  │  [img]  │  │  [img]  │  │  [img]  │  │  [img]  │                        │
│  │         │  │         │  │ current │  │         │                        │
...
│  └─────────┘  └─────────┘  └─────────┘  └─────────┘                        │
│                                                                             │
│  [Add All to Gallery]  [Discard Unselected]  [Generate More Variations]    │
│                                                                             │
│  [Done]                                                                     │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌─ Character: Bartender Jasper ───────────────────────────────────────────────┐
│                                                                             │
│  [...other fields...]                                                       │
│                                                                             │
│  ┌── Portrait Gallery ────────────────────────────────────────────────────┐ │
│  │                                                                        │ │
│  │  Active:          Other Variations:                                    │ │
│  │  ┌──────────┐    ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐         │ │
│  │  │   ★      │    │        │ │        │ │        │ │        │         │ │
│  │  │  [img]   │    │ [img]  │ │ [img]  │ │ [img]  │ │ [img]  │         │ │
│  │  │          │    │        │ │        │ │        │ │        │         │ │
│  │  │ Neutral  │    │Suspici │ │Friendly│ │ Angry  │ │Costume2│         │ │
│  │  └──────────┘    └────────┘ └────────┘ └────────┘ └────────┘         │ │
│  │                  [Set Active] [Delete] [Rename]                        │ │
│  │                                                                        │ │
│  │  [📁 Upload New]  [🎨 Generate New]                                   │ │
│  │                                                                        │ │
│  │  ⚠️ 4 portraits pending selection (from queue)  [View →]              │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
│  │  [+ Character] [+ Location] [+ Item] │ │  [Items]      [Maps]            │
│  │  [+ Scene]     [+ Map]               │ │                                 │
│  │                                      │ │  ┌───────────────────────────┐  │
│  └──────────────────────────────────────┘ │  │ Search: [____________]    │  │
│                                           │  └───────────────────────────┘  │
...
│  ┌── Basic Info ──────────────────────────────────────────────────────────┐ │
│  │                                                                        │ │
│  │  Name: [________________________] [🪄 Suggest Names]                   │ │
│  │                                                                        │ │
│  │  Description:                                                          │ │
│  │  ┌────────────────────────────────────────────────────────────────┐   │ │
│  │  │                                                                │   │ │
│  │  │                                                                │   │ │
│  │  └────────────────────────────────────────────────────────────────┘   │ │
│  │  [🪄 Expand Description] [🪄 Generate from Name]                      │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌── Archetype & Role ────────────────────────────────────────────────────┐ │
│  │                                                                        │ │
│  │  Base Archetype: [Hero ▼]     [🪄 Suggest from Description]           │ │
│  │                                                                        │ │
│  │  [Hero]      [Mentor]    [Guardian]   [Herald]                        │ │
...
│  │                                                                        │ │
│  │  ┌─────────────────────────────────────────────────────────────────┐  │ │
│  │  │ • Protect the village from the shadow curse         [×]        │  │ │
│  │  │ • Find the truth about their missing sister         [×]        │  │ │
│  │  └─────────────────────────────────────────────────────────────────┘  │ │
│  │                                                                        │ │
│  │  [+ Add Want Manually]  [🪄 Generate Wants from Archetype/Description] │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌── Visual Assets ───────────────────────────────────────────────────────┐ │
...
│  ┌── Basic Info ──────────────────────────────────────────────────────────┐ │
│  │                                                                        │ │
│  │  Name: [________________________] [🪄 Suggest]                         │ │
│  │                                                                        │ │
│  │  Parent Location: [None ▼]  (e.g., "Town" contains "Tavern")          │ │
│  │                                                                        │ │
...
│  │  │                                                                │   │ │
│  │  └────────────────────────────────────────────────────────────────┘   │ │
│  │  [🪄 Expand Description] [🪄 Generate Atmospheric Details]            │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌── Connections ─────────────────────────────────────────────────────────┐ │
...
│  │  Connected Locations:                                                  │ │
│  │  ┌───────────────────────────────────────────────────────────────────┐│ │
│  │  │ Town Square ──[Enters]──> [This Location]            [×]         ││ │
│  │  │ Kitchen ──[ConnectsTo]──> [This Location]  (bidirectional)  [×]  ││ │
│  │  └───────────────────────────────────────────────────────────────────┘│ │
│  │  [+ Add Connection]  [🪄 Suggest Logical Connections]                 │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌── Visual Assets ───────────────────────────────────────────────────────┐ │
...
│  │  │                                                                │   │ │
│  │  └────────────────────────────────────────────────────────────────┘   │ │
│  │  [📁 Upload Backdrop]  [🎨 Generate Backdrop]                         │ │
│  │                                                                        │ │
│  │  [ ] Has tactical grid map                                            │ │
│  │  [🎨 Generate Tilesheet] [📁 Upload Tilesheet]                        │ │
│  │                                                                        │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
...
│  ┌── Prompt ──────────────────────────────────────────────────────────────┐│
│  │                                                                        ││
│  │  Base (from character description):                                    ││
│  │  "A weathered middle-aged man with gray streaks in his brown hair,    ││
│  │   knowing eyes, and a guarded expression"                              ││
│  │                                                                        ││
│  │  Style modifiers: [Fantasy portrait ▼]                                ││
│  │                                                                        ││
│  │  Additional details:                                                   ││
│  │  [tavern lighting, medieval setting, detailed face              ]     ││
│  │                                                                        ││
│  │  Negative prompt:                                                      ││
...
│  └────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
│  Expression variants: [✓] Neutral  [✓] Suspicious  [ ] Friendly  [ ] Angry │
│  (generates multiple portraits for dialogue expressions)                    │
│                                                                             │
...
│  └─────────┘  └─────────┘  └─────────┘  └─────────┘                       │
│                                                                             │
│  [Use Style Reference...]  [Regenerate Selected]  [Generate More]          │
│                                                                             │
│  [Cancel]                                              [Use Selected]      │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
┌─ Grid Map Editor ───────────────────────────────────────────────────────────┐
│                                                                             │
│  Map: Dragon's Rest Inn - Main Hall                                         │
│                                                                             │
│  Tilesheet: [tavern_interior.png ▼]  [🎨 Generate New Tilesheet]           │
│                                                                             │
│  Size: [12] x [8] tiles    [Resize]                                        │
│                                                                             │
│  ┌── Tools ───┐  ┌── Grid ──────────────────────────────────────────────┐  │
│  │            │  │                                                      │  │
│  │  [🖌️ Paint] │  │  ┌──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┐             │  │
...
│  │  [4][5][6] │  │  └──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┘             │  │
│  │  [7][8][9] │  │                                                      │  │
│  │            │  │  Legend: ▓▓=Wall  ██=Table  ▒▒=Bar Counter           │  │
│  └────────────┘  └──────────────────────────────────────────────────────┘  │
│                                                                             │
│  Elevation layer: [Show ▼]    Passability: [Show ▼]                        │
│                                                                             │
│  [Cancel]                                                    [Save Map]    │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
|---------------|---------|--------------|-------|
| `character-portrait-generation` | NPC/PC face portraits | 256×256 | Supports expression variants |
| `character-sprite-generation` | Full-body sprites | 512×512 | Transparent background |
| `backdrop-generation` | Scene backgrounds | 1920×1080 | Visual novel style |
| `tilesheet-generation` | Grid map tiles | 512×512 (32×32 tiles) | Consistent tile style |
| `item-icon-generation` | Inventory item icons | 64×64 | Transparent background |

### Extended Workflows (All Variants)
| Workflow Name | Purpose | Default Size | Notes |
|---------------|---------|--------------|-------|
| `portrait-expression-variant` | Same character, different expression | 256×256 | Uses style reference from existing portrait |
| `character-emotion-sheet` | Grid of 6-9 expressions | 768×768 | Single image with expression grid |
| `map-region-backdrop` | Backdrop for clickable map region | 1280×720 | Smaller than full backdrop |
| `item-set-generation` | 4-6 themed items at once | 256×256 grid | e.g., "potion set", "weapon set" |
| `costume-variant` | Same character, different outfit | 512×512 | Uses style reference from base sprite |
| `location-time-variant` | Same location, different time/weather | 1920×1080 | Day/night/rain variants |
...
├── views/
│   └── dm_view.rs          # Add tab switching to Creator mode
├── components/
│   └── creator/            # NEW
│       ├── mod.rs
│       ├── entity_browser.rs       # Tree view of world entities
│       ├── character_form.rs       # Character creation/editing
│       ├── location_form.rs        # Location creation/editing
│       ├── item_form.rs            # Item creation/editing
│       ├── map_editor.rs           # Grid map painting
│       ├── generation_modal.rs     # ComfyUI generation UI
│       ├── generation_queue.rs     # Background generation tracking
│       ├── suggestion_button.rs    # Reusable LLM suggest button
│       └── ai_assistant_panel.rs   # Freeform AI chat for creation
```
...
├── creation_service.rs     # Orchestrates entity creation
├── generation_service.rs   # Manages ComfyUI requests
└── suggestion_service.rs   # Handles LLM suggestions
```
...
├── http/
│   └── generation_routes.rs   # NEW: REST endpoints for generation
└── comfyui.rs                 # Extend with workflow loading
```
...
| **Creation Flow** | Form-Based | Standard forms with inline `[🪄 Suggest]` buttons |
...
### Phase 11A: Asset Gallery Foundation (Engine) ✅ COMPLETE
...
### Phase 11B: Generation Queue System (Engine) ✅ COMPLETE
...
├── domain/
│   ├── entities/
│   │   ├── gallery_asset.rs      # NEW
│   │   └── generation_batch.rs   # NEW
│   └── value_objects/
│       └── ids.rs                # Add AssetId, BatchId
├── application/
│   ├── services/
│   │   ├── generation_service.rs # NEW
│   │   └── suggestion_service.rs # NEW
│   └── dto/
│       └── generation_dto.rs     # NEW
└── infrastructure/
    ├── persistence/
    │   └── asset_repository.rs   # NEW
    ├── http/
    │   ├── asset_routes.rs       # NEW
    │   └── suggestion_routes.rs  # NEW
    └── comfyui.rs                # Extend with workflow loading
```
...
├── presentation/
│   ├── views/
│   │   └── dm_view.rs            # Add tabbed navigation
│   └── components/
│       └── creator/              # NEW directory
│           ├── mod.rs
│           ├── entity_browser.rs
│           ├── character_form.rs
│           ├── location_form.rs
...
│           ├── generation_modal.rs
│           ├── selection_modal.rs
│           ├── suggestion_button.rs
│           └── map_editor.rs
├── application/
│   └── services/
│       ├── generation_service.rs # NEW
│       └── creation_service.rs   # NEW
└── infrastructure/
    └── websocket/
        └── messages.rs           # Add generation events
```
...
```rust
// Engine → Player (generation updates)
...
// Player → Engine (generation requests)
